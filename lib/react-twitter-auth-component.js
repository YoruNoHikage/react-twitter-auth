  ...
  _createClass(TwitterLogin, [{
    ...
    value: function getRequestToken() {
      ...
      return window.fetch(this.props.requestTokenUrl, {
        ...
        popup.close();
        return _this2.props.callback({ error: error });
      });
    }
  }, {
    key: 'openPopup',
    ...
    value: function polling(popup) {
      ...
      var polling = setInterval(function () {
        if (!popup || popup.closed || popup.closed === undefined) {
          ...
          _this3.props.callback({ error: new Error('Popup has been closed by user') });
        }
        ...
        try {
          if (!popup.location.hostname.includes('api.twitter.com') && !popup.location.hostname == '') {
            if (popup.location.search) {
              ...
              closeDialog();
              return _this3.props.callback({ oauthVerifier: oauthVerifier, oauthToken: oauthToken });
            }

            closeDialog();
            return _this3.props.callback({
              error: new Error('OAuth redirect has occurred but no query or hash parameters were found. ' + 'They were either not set during the redirect, or were removed—typically by a ' + 'routing library—before Twitter react component could read it.')
            });
          }
        } catch (error) {
    ...
    value: function render() {
      if (typeof this.props.render === 'function') {
        return this.props.render({
          ...
          icon: _react2.default.createElement(_twitter2.default, { color: '#00aced', size: 25 })
        });
      }
